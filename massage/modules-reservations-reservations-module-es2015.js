...
/* harmony import */ var _angular_cdk_keycodes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/cdk/keycodes */ "./node_modules/@angular/cdk/esm2015/keycodes.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
...
let ReservationsComponent = class ReservationsComponent {
    constructor(translateService, userService, renderer) {
    ...
    ngOnInit() {
        this.userService.currentLanguage.subscribe((lang) => {
            ...
            if (lang === "de") {
                ...
                this.initialCalendly(this.container.nativeElement, "https://onlinecalendar.medidoc.ch/BookAppointment?cgid=YGPbSfCp90y9lmSq_80Oyg");
                ...
                this.initialCalendly(this.container1.nativeElement, "https://onlinecalendar.medidoc.ch/BookAppointment?cgid=YGPbSfCp90y9lmSq_80Oyg");
            }
        });
    }
    initialCalendly(nativeElement, url) {
 ...
 */
let ReservationsRoutingModule = class ReservationsRoutingModule {
};
...
//# sourceMappingURL=modules-reservations-reservations-module-es2015.js.map