...
const API_BASE = 'https://ew2rqml437.execute-api.us-east-1.amazonaws.com/v1';
...
let AppComponent = class AppComponent {
    constructor(breakpointObserver, translate, userService) {
        this.breakpointObserver = breakpointObserver;
        this.translate = translate;
        this.userService = userService;
        this.title = 'Physiotherapie Glattbrugg';
        this.isHandset$ = this.breakpointObserver.observe([_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_3__["Breakpoints"].Tablet, _angular_cdk_layout__WEBPACK_IMPORTED_MODULE_3__["Breakpoints"].Handset])
