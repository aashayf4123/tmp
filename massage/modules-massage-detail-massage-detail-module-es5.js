...
var ReserveContactComponent = /** @class */ (function () {
    function ReserveContactComponent() {
    }
    ...
    return ReserveContactComponent;
}());
...
var ReserveContactModule = /** @class */ (function () {
    function ReserveContactModule() {
    }
...
var MassageDetailModule = /** @class */ (function () {
    function MassageDetailModule() {
    }
...
var MassageDetailRoutingModule = /** @class */ (function () {
    function MassageDetailRoutingModule() {
    }
    ...
    return MassageDetailRoutingModule;
}());
...
var MassageDetailComponent = /** @class */ (function () {
    function MassageDetailComponent(route) {
        this.route = route;
        this.masg = [
            {
                path: "manual-therapy",
    ...
    MassageDetailComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.subscribe(function (param) {
            console.log(param.id);
            _this.val = param.id;
            _this.item =
                _this.masg.find(function (x) { return x.path == _this.val; }) ||
                    _this.prevent.find(function (p) { return p.path == _this.val; }) ||
                    _this.about.find(function (x) { return x.path == _this.val; });
            console.log(_this.item);
        });
        // this.route.queryParams.subscribe(p => console.log(p));
    };
    MassageDetailComponent.ctorParameters = function () { return [
...
//# sourceMappingURL=modules-massage-detail-massage-detail-module-es5.js.map